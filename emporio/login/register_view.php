...
<head>
    ...
    <title>Register - Emporio E-Shop</title>
...
<body>
	...
	<p class="register-link" style="text-align:center;">Already have an account? <a href="../index.php">Login</a></p>
    ...
    <script>
	    ...
	    if (!addressRegex.test(add)) {
                alert('Please enter a valid Street Address. Start with an Upper case letter');
                return false;
            }
