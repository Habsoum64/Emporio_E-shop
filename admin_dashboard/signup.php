                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary">Emporio</h3>
                            </a>
                            <h3>Sign Up</h3>
                        </div>
                        <form action="../actions/register_action.php" method="post">
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" class="form-control" id="floatingAdminCode" name="admin_code" placeholder="Admin Code (if registering as admin)">
                                <label for="floatingAdminCode">Admin Code (if registering as admin)</label>
                            </div>
